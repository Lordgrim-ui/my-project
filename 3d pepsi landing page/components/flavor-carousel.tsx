...
const flavors = [
  {
    ...
    description: "The unmistakable taste of Pepsi. Bold, refreshing, and perfectly balanced since 1893.",
    image: "/images/pepsi-classic.png",
    bgColor: "from-[#004B87]/20 via-[#004B87]/10 to-transparent",
    accentColor: "#004B87",
  },
  {
    id: 2,
    ...
    description: "All the taste of Pepsi, with zero sugar. Boldly refreshing without the guilt.",
    image: "/images/pepsi-zero.png",
    bgColor: "from-[#1a1a1a]/20 via-[#1a1a1a]/10 to-transparent",
    accentColor: "#1a1a1a",
  },
  {
    id: 3,
    name: "Pepsi Wild Cherry",
    tagline: "Cherry Perfection",
    description: "A bold twist on the classic. Smooth, refreshing, and deliciously different.",
    image: "/images/pepsi-wild-cherry.png",
    bgColor: "from-[#FF6B35]/20 via-[#FF6B35]/10 to-transparent",
    accentColor: "#FF6B35",
  },
]
                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="space-y-4">
                      ...
                      {!currentFlavor.mystery && (
                        ...
                        >
                          {["Refreshing", "Iconic Taste", "Great for Sharing", "Available Everywhere"].map((badge) => (
                            <span
                              key={badge}
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        transition={{ type: "spring", stiffness: 400, damping: 17 }}
                        style={{ backgroundColor: currentFlavor.accentColor, color: currentFlavor.id === 2 ? "white" : "#121212" }}
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                      >
                        <motion.span
