...
const activations = [
  {
    icon: Sparkles,
    title: "Taste Experiences",
    description: "Experience Pepsi at exclusive brand events and taste experiences.",
    cta: "Find Events",
  },
  {
    icon: Dumbbell,
    title: "Sports & Fitness",
    description: "Partner with Pepsi to refresh your community and fans.",
    cta: "Partner With Us",
  },
  {
    icon: Building2,
    title: "Restaurants & Venues",
    description: "Stock Pepsi at your establishment. Custom solutions available.",
    cta: "Get Quote",
  },
  {
    icon: Calendar,
    title: "Sponsorships",
    description: "Bring Pepsi to your events and celebrations.",
    cta: "Sponsor Event",
  },
]
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-black text-[#121212] tracking-tighter mt-2 overflow-hidden">
            ...
            <motion.span
              className="text-[#004B87] inline-block"
              initial={{ y: 100 }}
              whileInView={{ y: 0 }}
              viewport={{ once: true }}
          ...
          >
            From events to partnerships, bring Pepsi to your audience and business.
          </motion.p>
        </motion.div>
        ...
        >
          {activations.map((activation, index) => (
            ...
            >
              <motion.div
                className="absolute inset-0 bg-[#004B87]/0 group-hover:bg-[#004B87]"
                transition={{ duration: 0.4 }}
              />

              <div className="relative z-10">
            <motion.div
              className="w-11 h-11 rounded-xl bg-[#004B87] flex items-center justify-center mb-4 group-hover:bg-[#FF6B35] transition-colors duration-300"
              whileHover={{ rotate: 10, scale: 1.1 }}
              transition={{ type: "spring", stiffness: 400, damping: 17 }}
            >
              <activation.icon className="w-5 h-5 text-white group-hover:text-white transition-colors duration-300" />
            </motion.div>
                ...
                <motion.button
                  className="flex items-center gap-2 text-[#004B87] group-hover:text-white font-bold text-xs tracking-wide transition-colors duration-300"
                  whileHover={{ x: 4 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                >
                  {activation.cta}
