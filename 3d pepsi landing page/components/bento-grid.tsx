...
const features = [
  {
    ...
    description: "Trusted by billions since 1893",
    accent: "#004B87",
  },
  {
    icon: Flame,
    title: "100%",
    subtitle: "Taste",
    description: "The bold, refreshing Pepsi experience",
    accent: "#FF6B35",
  },
  {
    icon: Brain,
    title: "#1",
    subtitle: "Choice Globally",
    description: "Loved in over 200 countries worldwide",
    accent: "#004B87",
  },
  {
    icon: Sparkles,
    title: "3",
    subtitle: "Amazing Flavors",
    description: "Classic, Zero Sugar, and Wild Cherry",
    accent: "#FF6B35",
  },
]
  ...
  return (
    <section id="formula" className="relative py-16 bg-[#121212] overflow-hidden">
      ...
      <div ref={ref} className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.span
            className="inline-block font-mono text-[#004B87] text-[10px] tracking-[0.3em] uppercase"
          ...
          {/* Animated underline */}
          <motion.div
            className="h-[2px] w-12 bg-[#004B87] mx-auto mt-3 rounded-full"
            initial={{ scaleX: 0 }}
