...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white via-[#004B87]/5 to-white" />

      <motion.div
        className="absolute top-20 left-10 w-24 h-24 rounded-full bg-[#004B87]/20 blur-3xl"
        animate={{
          x: [0, 30, 0],
          y: [0, -20, 0],
          scale: [1, 1.1, 1],
      ...
      />
      <motion.div
        className="absolute bottom-40 right-20 w-32 h-32 rounded-full bg-[#004B87]/10 blur-3xl"
        animate={{
          x: [0, -40, 0],
          y: [0, 30, 0],
          scale: [1, 1.2, 1],
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <motion.div style={{ opacity }} className="space-y-5">
            <motion.div
              ...
              animate="visible"
              custom={0}
              className="inline-flex items-center gap-2 bg-[#004B87] text-white px-3 py-1.5 rounded-full text-xs font-mono tracking-wider"
            >
              <motion.span
            ...
            <div className="space-y-1 overflow-hidden">
              ...
              >
                The iconic cola taste that generations have loved. Bold. Refreshing. Unmistakable.
              </motion.p>
            </div>
            ...
            >
              <motion.button
                className="bg-[#004B87] text-white px-6 py-3 rounded-full font-bold text-sm tracking-wide flex items-center gap-2 group relative overflow-hidden"
            ...
            >
              {["Great Taste", "Iconic Flavor", "Refreshing Carbonation", "Iconic Since 1893"].map((benefit, i) => (
                <motion.div
                  key={benefit}
                ...
                >
                  <div className="w-1.5 h-1.5 bg-[#004B87] rounded-full" />
                  {benefit}
                </motion.div>
              ))}
            </motion.div>
          ...
          <motion.div style={{ y, scale }} className="relative flex justify-center">
            <motion.div variants={scaleInVariants} initial="hidden" animate="visible" className="relative">
              <motion.div
                className="absolute inset-0 bg-[#004B87]/30 blur-[80px] rounded-full scale-75"
                animate={{
              ...
              >
                <Image
                  src="/images/pepsi-classic.png"
                  alt="Pepsi Classic - The Iconic Cola"
                  width={350}
                  height={525}
