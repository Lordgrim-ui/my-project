...
export function Navigation() {
  ...
  const navLinks = [
    ...
    { label: "Taste Stories", href: "#creators" },
    { label: "Where to Buy", href: "#distributors" },
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          ...
          >
            <span className={scrolled ? "text-white" : "text-[#121212]"}>PEPSI</span>
          </motion.span>
        </Link>
        ...
        <motion.button
          className="hidden md:block bg-[#004B87] text-white px-6 py-2.5 rounded-full font-bold text-sm tracking-wide relative overflow-hidden"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          transition={{ type: "spring", stiffness: 400, damping: 17 }}
        >
          <motion.div
            ...
            animate={{
              boxShadow: [
                "0 0 20px rgba(0,75,135,0.3)",
                "0 0 40px rgba(0,75,135,0.6)",
                "0 0 20px rgba(0,75,135,0.3)",
              ],
            }}
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="px-6 py-4 space-y-4">
              ...
              <motion.button
                className="w-full bg-[#004B87] text-white px-6 py-3 rounded-full font-bold text-sm tracking-wide mt-4"
